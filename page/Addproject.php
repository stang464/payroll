            ...
            <form>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="ProjectName" class="form-control" id="inputProjectName" placeholder="">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputDetail">รายละเอียด</label>
                        <input type="Detail" class="form-control" id="inputDetail" placeholder="">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label for="inputProjectName">ลูกค้า</label>
                        <input type="ProjectName" class="form-control" id="inputProjectName" placeholder="">
                    </div>
